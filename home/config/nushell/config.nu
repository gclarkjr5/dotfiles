...
alias nb = nix-build
alias nix-refresh = nu --commands "cd ~/dotfiles; nix run . --impure --extra-experimental-features nix-command --extra-experimental-features flakes"
...
#alias vector = docker run -i -v $"($env.PWD)/:/etc/vector/" --rm timberio/vector:0.32.1-debian
# use ~/.custom_nu/.proxy_setup.nu configure_proxy
# configure_proxy
# alias at_office = configure_proxy at_office
